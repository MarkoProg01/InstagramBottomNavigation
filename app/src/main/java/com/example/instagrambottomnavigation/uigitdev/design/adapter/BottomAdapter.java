...
public class BottomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        resizeItemWidth(((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_parent);
        setIcon(((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_icon, bottomItems.get(position).getItemIconId());
        selectedStyle(
                ((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_icon,
                bottomItems.get(position).getItemId(),
                bottomItems.get(position).getItemIconId(),
                bottomItems.get(position).getItemFillIconId());

        visibilityChange(((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_notification, bottomItems.get(position).isHasNotification());

        setOnClickItem(
                ((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_item_parent,
                ((com.example.instagrambottomnavigation.uigitdev.design.adapter.viewholder.BottomBarViewHolder) holder).bottom_icon, position,
                bottomItems.get(position).getItemId(),
                bottomItems.get(position).getItemIconId(),
                bottomItems.get(position).getItemFillIconId());
    }
